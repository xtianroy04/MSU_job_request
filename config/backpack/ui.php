...
return [
    ...
    */
    ...
    'project_name' => 'Job Request System',
    ...
    'project_logo' => '<div style="text-align: center;"><img src="/images/logo.png" height="60px" alt="logo"></div><h5 style="margin-top: 18px; font-size: 18px; text-align: center;">&nbspJob Request System</h5>',
    ...
    'developer_name' => 'Mindanao State University at Naawan',

    // Developer website. Link in footer. Type false if you want to hide it.
    'developer_link' => 'https://msunaawan.edu.ph/',
